                        ...
                        <div class="container-xxl d-flex flex-grow-1 flex-stack">
                            ...
                            <div class="d-flex align-items-center me-5">
                                ...
                                <a href="../../demo11/dist/index.html">
                                    <img alt="Logo" src="assets/media/logos/logo-demo11.svg"
                                ...
                                <div class="d-flex align-items-center ms-3 ms-lg-4" id="kt_header_user_menu_toggle">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px"
                                        ...
                                        <div class="menu-item px-5">
                                            <a href="../../demo11/dist/account/overview.html"
                                        ...
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-5">
                                            <a href="../../demo11/dist/apps/projects/list.html"
                            ...
                            <div class="header-menu flex-column flex-lg-row" data-kt-drawer="true"
                                ...
                                <div class="flex-shrink-0 p-4 p-lg-0 me-lg-2">
                                    <a href="../../demo11/dist/documentation/getting-started.html"
                                        ...
                                        title="200+ in-house components and 3rd-party plugins">Docs &amp;
                                        Components</a>
                                </div>
                                <!--end::Actions-->
                            </div>
                                ...
                                <tbody>
                                    @foreach ($data as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-danger" onclick="deleteConfirmation({{ $item->id}})">delete</button>
                                            </td>
                                        </tr>
                                    @endforeach
